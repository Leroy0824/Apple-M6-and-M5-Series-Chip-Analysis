...
1. Report.pdf: the main report. It compares Mac mini and Mac Studio chip options by normalising RAM and storage upgrade costs, then evaluating both raw performance and cost-per-value.
2. Report.tex: the LaTeX source file used to generate Report.pdf.
