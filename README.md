...
1. Report.pdf: the main report. It compares Mac mini and Mac Studio chip options by normalizing RAM and storage upgrade costs, then evaluating both raw performance and cost-per-value.
